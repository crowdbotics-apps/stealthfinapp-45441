"""
Django settings for stealthfinapp_45441 project.
...
ROOT_URLCONF = 'stealthfinapp_45441.urls'
...
WSGI_APPLICATION = 'stealthfinapp_45441.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "stealthfinapp_45441 API",
    "DESCRIPTION": "API documentation for stealthfinapp_45441 App",
    "VERSION": "v1",
}
